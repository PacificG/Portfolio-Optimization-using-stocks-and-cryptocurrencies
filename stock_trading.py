...
def get_model_path(window_length, predictor_type, use_batch_norm,datatype):
    if use_batch_norm:
        batch_norm_str = 'batch_norm'
    else:
        batch_norm_str = 'no_batch_norm'
    return 'weights/{}/{}/window_{}/{}/checkpoint.ckpt'.format(datatype, predictor_type, window_length, batch_norm_str)


def get_result_path(datatype, window_length, predictor_type, use_batch_norm):
    if use_batch_norm:
        batch_norm_str = 'batch_norm'
    else:
        batch_norm_str = 'no_batch_norm'
    return 'results/{}/{}/window_{}/{}/'.format(datatype, predictor_type, window_length, batch_norm_str)


def get_variable_scope(datatype, window_length, predictor_type, use_batch_norm):
    if use_batch_norm:
        batch_norm_str = 'batch_norm'
    else:
        batch_norm_str = 'no_batch_norm'
    return '{}_{}_window_{}_{}'.format(datatype, predictor_type, window_length, batch_norm_str)
...
if __name__ == '__main__':
    ...
    model_save_path = get_model_path(args['data'], window_length, predictor_type, use_batch_norm)
    summary_path = get_result_path(args['data'], window_length, predictor_type, use_batch_norm)

    variable_scope = get_variable_scope(args['data'], window_length, predictor_type, use_batch_norm)
